...
export default function WelcomeBanner({ user }) {
  ...
  return (
    <section className="relative isolate overflow-hidden rounded-2xl border border-teal-100 bg-teal-50 px-6 py-7 sm:px-10">
      <img src={`${process.env.PUBLIC_URL}/landingpage.png`} alt="" aria-hidden="true" className="absolute inset-y-0 right-0 -z-10 hidden h-full w-1/2 object-cover opacity-90 md:block" />
